...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-2xl text-popover-foreground",
        // Liquid Glass effect
        "glass-surface border border-white/20 dark:border-white/10",
        // Animation
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-black/5 dark:focus:bg-white/10 focus:text-accent-foreground",
